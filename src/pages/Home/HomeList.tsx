          ...
          <div className="mt-8 lg:-mx-6 lg:flex lg:items-center lg:px-12">
            ...
            <div className="flex flex-col  lg:w-1/2">
              ...
              <div className="mt-6 lg:mt-0 lg:mx-6 ">
                ...
                <p className="block mt-4 text-lg  font-normal text-gray-600 hover:underline">
                  웹 퍼블리싱과 프론트엔드 부트캠프 과정을 수료하면서 HTML과 CSS를 시멘틱하게 다룰수 있게 되었으며,
                  사람들과 함께 협업하며 성장하기위해 리액트와 타입스크립트를 이용한 프로젝트와 cs지식을 위한 스터디를
                  4개 진행한 경험이 있습니다.
                </p>
                <p className="block mt-4 text-lg  font-normal text-gray-600 hover:underline">
                  개발자가 되기 전에는 항공정비사와 모바일 인력소장으로 활동하며 다양한 경험을 쌓았습니다. 그런 경험들을
