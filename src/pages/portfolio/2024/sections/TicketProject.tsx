      ...
      <div className="flex flex-wrap items-center">
        ...
        <div className="px-6 mr-auto ml-auto w-full md:px-4">
          <div>
            ...
            <p className="mb-4 w-full text-gray-600 sm:flex-nowrap">제작기간 :23.09.20. ~ 12.06</p>
          ...
          <div className="flex relative flex-col mb-6 w-full rounded-lg shadow-lg">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex relative flex-row gap-4 p-2"></div>
            </div>
          </div>
        </div>
      </div>
