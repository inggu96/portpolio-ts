...
export const projects: Project[] = [
  ...
  },
  {
    ...
    achievements: [
      "전임자의 9,000줄의 하드코딩된 json코드의 구조를 개선해 3D모델의 위치,포지션값을 DB 시스템으로 마이그레이션 이후 직접 수동으로 입력하던 포지션값들을 동적패널을 구성해 화면에서 바로 위치시키는 자동화 시스템 구축해 이전 6개월 걸렸던 작업을 1/3로 감축해 2개월 만에 완료",
      "행사 배너 렌더링 후 기타 픽토그램과 같이 토글처리, 에스컬레이터, 엘리베이터, 공간 텔레포트 등 커스텀 기능 개발",
      "3D 파티션 개별 토글 시스템 구현",
